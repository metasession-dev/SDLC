...
```bash
semgrep scan --config auto [SOURCE_DIR]/ --json > compliance/evidence/REQ-XXX/sast-results.json 2>&1
...
|-----------|-------|--------|--------|----------|
| E2E (Playwright) | [N] | [N] | 0 | `compliance/evidence/REQ-XXX/e2e-results.json` |
| Unit | [N] | [N] | 0 | `compliance/evidence/REQ-XXX/unit-test-results.txt` |
