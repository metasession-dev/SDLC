...
- E2E Tests: [N]/[N] passed (full suite)
- TypeScript: 0 errors
...
They cannot approve until CI is green. They then verify the comprehensive local evidence and compliance artifacts.
...
Per Test Policy, the GitHub PR approval is the formal sign-off. Two independent verification sources:
